...
**目的**：
  - 虽然已经有翻译的书籍;但是想follow更新,借助chatGPT/gemini翻译成中文，(加速学习节奏，掌握，并举一反三)
  - 英文源书是开源的，翻译成中文工作也持续更新，也是开源的，可以作为学习资料, 在线阅读可编辑，希望一起参与改进。

**访问地址**: https://weedge.github.io/perf-book-cn/zh/
...
> - 翻译的[源文件存储库](https://github.com/dendibakh/perf-book)对应的commit: [5ddfadc](https://github.com/weedge/perf-book/commit/5ddfadc9c292b7dbac4d868e7a25b9a6ea3648c8)
