...
![A Flame Graph for [x264](https://openbenchmarking.org/test/pts/x264) benchmark.](https://raw.githubusercontent.com/dendibakh/perf-book/main/img/perf-tools/Flamegraph.jpg){#fig:FlameGraph width=90%}
